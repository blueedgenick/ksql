...
@UdfDescription(name = "arrays_to_map",
...
public class ArraysToMap {
  ...
  public Map<String, Object> map(final List<String> inputKeys, final List<Object> inputValues) {
    ...
    final Map<String, Object> outputMap = Maps.newHashMapWithExpectedSize(inputKeys.size());
    for (int i = 0; i < inputKeys.size(); i++) {
      final String thisKey = inputKeys.get(i);
      final Object thisValue = inputValues.get(i);
      if (thisValue != null) {
